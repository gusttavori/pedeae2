...
export const onOrderStatusChange = functions.firestore
    ...
    .onUpdate(async (change, context) => { // Traz a Propriedade 'change' Que Possui 2 Copias. A copia ANTES de Mudar (Before) e A Copia DEPOIS da Mudanca (After). Mutation Payload Diffs Changes Old and New Data
